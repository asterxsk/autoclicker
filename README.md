...
Note: This is still a work in project. Bugs are expected.
...
Tray Access: Includes a sleek tray icon and menu for easy access.

Customizable Hotkeys: Set your own hotkeys easily.
...
Set your desired click interval, hotkey, and other options in the app.

Press your hotkey to start or stop clicking.

Download

You can download the latest version from the Downloads Page on our website.

(Or, if you want to host the file on GitHub Releases):
